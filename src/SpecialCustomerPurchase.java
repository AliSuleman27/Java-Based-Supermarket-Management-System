...
public class SpecialCustomerPurchase extends JFrame {
   ...
   // ArrayList<Discounts> AvailedDiscounts = new ArrayList<>();
    ...
    public SpecialCustomerPurchase(Customer customer) {
        ...
        // checkOut.setPreferredSize(new Dimension(100, 40));
         ...
         JButton promoCode = new JButton("Promo Code");
         promoCode.setForeground(Color.WHITE);
         promoCode.setBackground(Color.RED);
         
         promoCode.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    ...
                    promoFrame.setSize(600,350);
                    promoFrame.setLayout(new BorderLayout());
                    
                    JPanel leftPanel = new JPanel(new FlowLayout());
                    JLabel codeLabel = new JLabel("Promo Code: ");
                    JTextField codeField = new JTextField(10);
                    JButton addButton = new JButton("Apply Code");
                    addButton.setBackground(Color.GREEN);
                    addButton.setForeground(Color.WHITE);
                     leftPanel.add(codeLabel);
                    leftPanel.add(codeField);
                    leftPanel.add(addButton);
                    promoFrame.add(leftPanel);
                    
                    
                    promoFrame.setLocationRelativeTo(contentPane);
                     ...
                     promoFrame.add(leftPanel, BorderLayout.WEST);
                     promoFrame.add(scrollPane, BorderLayout.CENTER);
                    ...
                    addButton.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                if (!code.isEmpty()) {
                                    ...
                                    Discounts selectedOne = new Discounts();
                                    boolean st = false;
                                   
                                    for(Discounts dd : AllDiscounts){
                                      
                                        if(dd.getDiscountCode().equals(codeField.getText()) && dd.getCategorey().equals("Promo Code"))
                                        {
                                            selectedOne = dd;
                                            st = true;
                                            break;
                                    ...
                                    if(st){
                                        if(verify(code))
                                        {
                                            ...
                                            sale.AvailedDiscounts.add(selectedOne);
                                            addToRightPanel(selectedOne);
                                            
                                        }
                                        else
                                        {
                                            JOptionPane.showMessageDialog(null, "You have already Used to Promo Code");
                                        }
                                    }
                                    else
                                    {
         ...
         AvailDiscounts.setBackground(Color.cyan);
         ...
         AvailDiscounts.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                   ...
                   for (Discounts discount : allDiscounts) {
                    if(discount.getStatus() && (discount.getCategorey().equals("Special Only") || discount.categorey.equals("Both"))){   
